...
const WORD_REPLACEMENTS = [
    ...
    [`${WB}twat${WB}`, "twaaat"],
    [`${WB}cmon${WB}`, "come on"],
    [`${WB}epicer${WB}`, "epic er"],
    [`${WB}yk${WB}`, "you know"],
    [`${WB}omg${WB}`, "oh my god"],
    [`${WB}btw${WB}`, "by the way"],
    [`${WB}b\\)${WB}`, "cool face"],
    [`${WB}ppl${WB}`, "people"],
    [`${WB}ic${WB}`, "I see"],
    [`${WB};\\-;${WB}`, "crying"],
    [`${WB}im${WB}`, "I'm"],
    [`${WB}em${WB}`, "them"],
    [`${WB}theres${WB}`, "there's"],
    [`${WB}oml${WB}`, "oh my lord"],
    [`${WB}ur${WB}`, "your"],
    [`${WB}idk${WB}`, "I don't know"],
    [`${WB}idc${WB}`, "I don't care"],
    [`${WB}ngl${WB}`, "not gonna lie"],
    [`${WB}imo${WB}`, "in my opinion"],
    [`${WB}imho${WB}`, "in my honest opinion"],
    [`${WB}ty${WB}`, "thank you"],
    [`${WB}wdym${WB}`, "what do you mean"],
    [`${WB}tho${WB}`, "though"],
    [`${WB}welp${WB}`, "whelp"],
    [`${WB}wth${WB}`, "what the hell"],
    [`${WB}wtf${WB}`, "what the frick"],
    [`${WB}og${WB}`, "OG"],
    [`${WB}yt${WB}`, "YouTube"],
    [`${WB}jk${WB}`, "JK"],
    [`${WB}afk${WB}`, "AFK"],
    [`${WB}smh${WB}`, "shaking my head"],
    [`${WB}gtg${WB}`, "gotta go"],
    [`${WB}g2g${WB}`, "gotta go"],
    [`${WB}ik${WB}`, "I know"],
    [`${WB}ew${WB}`, "eww"],
    ...
    [`${WB}<3${WB}`, "heart"],
    [`${WB}fr${WB}`, "for real"],
    [`${WB}frfr${WB}`, "for real for real"],
    [`${WB}ikr${WB}`, "I know, right?"],
    [`${WB}yw${WB}`, "you're welcome"],
    [`${WB}dont${WB}`, "don't"],
    [`${WB}rn${WB}`, "right now"],
    [`${WB}ig${WB}`, "I guess"],
    [`${WB}alr${WB}`, "alright"],
    ...
    [`${WB}sus${WB}`, "suss"],
    [`${WB}gn${WB}`, "goodnight"],
    [`${WB}vtuber${WB}`, "vee toober"],
    [`${WB}envtuber${WB}`, "E N vee toober"],
    [`${WB}pls${WB}`, "please"],
    [`${WB}tysm${WB}`, "thank you so much"],
    [`${WB}ily${WB}`, "I love you"],
    [`${WB}thx${WB}`, "thanks"],
    [`${WB}abt${WB}`, "about"],
    [`${WB}plz${WB}`, "please"],
    [`${WB}rlly${WB}`, "really"],
    ...
    [`${WB}grr${WB}`, "gyrrr"],
    [`${WB}tf${WB}`, "the frick"],
    [`${WB}tbh${WB}`, "to be honest"],
    [`${WB}brb${WB}`, "be right back"],
    [`${WB}hru${WB}`, "how are you"],
    [`${WB}irl${WB}`, "IRL"],
    [`${WB}bf${WB}`, "boy-frog"],
    [`${WB}wyd${WB}`, "what you doing"],
    [`${WB}bbg${WB}`, "babygirl"],
    [`${WB}stfu${WB}`, "shut the heck up"],
    [`${WB}omfg${WB}`, "oh my hecking god"],
    [`${WB}wingman${WB}`, "wing-man"],
    [`${WB}havent${WB}`, "haven't"],
    [`${WB}hmpf${WB}`, "hmpf"],
    [`${WB}kys${WB}`, "reconsider what you are doing"],
    [`${WB}\\/th${WB}`, "slash threat"],
    [`${WB}nfts${WB}`, "NFTs"],
    [`${WB}nft${WB}`, "NFT"],
    [`${WB}ai${WB}`, "AI"],
    [`${WB}rq${WB}`, "real quick"],
    ...
    [`${WB}wb${WB}`, "wub"],
    [`${WB}tn${WB}`, "tonight"],
    [`${WB}henlowo${WB}`, "hen-low-woah"],
    [`${WB}hellowo${WB}`, "hell-oh-woah"],
    [`${WB}fml${WB}`, "frick my life"],
    [`${WB}tos${WB}`, "toss"],
    [`${WB}ttyl${WB}`, "talk to you later"],
    [`${WB}it${WB}`, "it"],
    [`${WB}tts${WB}`, "text to speech"],
    [`${WB}bo'om${WB}`, "boddum"],
    [`${WB}lol${WB}`, "teehee"],
    [`${WB}lmao${WB}`, "teehee"],
    [`${WB}lmafo${WB}`, "teehee"],
    [`${WB}lmfao${WB}`, "teehee"],
    [`${WB}google${WB}`, "gog-lay"],
]
...
class TwitchMessage {
    ...
    get filteredMessage() {
        ...
        for(let [k, v] of WORD_REPLACEMENTS) {
            workingMessage = workingMessage.replace(new RegExp(k), v);
        }
